...
#define INIT_AE_BV                                  (5000)      // scale by 1000, means 5.0 BV, equal to LV 10
...
// AE converge speed
#define AE_SPEED_MODE                               (AE_CONVERGE_NORMAL)    //sync with ae_converge_level_type_t: 0:normal, 1:direct, 2:fast, 3:smooth, 4:slow
#define AE_SPEED_FBASED_SPEED                       (0.00001)
#define AE_SPEED_FMAX_STEP                          (0.6)
#define AE_SPEED_NORMAL                             (20)
#define AE_SPEED_DIRECT                             (100)
#define AE_SPEED_SLOW                               (5)
#define AE_SPEED_SMOOTH                             (10)
#define AE_SPEED_FAST                               (70)

// AE wdr control setting
#define AE_WDR_ENABLE                               (1)             // enable wdr or not, 0: disable, 1: enable
#define AE_WDR_BVZONE_LOW_START                     (0)             // scale by 1000, start of interpolation range between low and middle brightness zone
#define AE_WDR_BVZONE_LOW_END                       (2000)          // scale by 1000, end of interpolation range between low and middle brightness zone
#define AE_WDR_BVZONE_HIGH_START                    (3000)          // scale by 1000, start of interpolation range between middle and high brightness zone
#define AE_WDR_BVZONE_HIGH_END                      (4000)          // scale by 1000, end of interpolation range between middle and high brightness zone

#define AE_WDR_MAX_MIDTONES_GAIN                    {100, 300, 500} // scale by 100, valid range: 100~800, means 1.0x/3.0x/5.0x for low/middle/high region
#define AE_WDR_MAX_SHADOWS_GAIN                     {100, 200, 200} // scale by 100, valid range: 100~400, means 1.0x/2.0x/2.0x for low/middle/high region
#define AE_WDR_HIST_HIGHLIGHT_TARGET                {200, 200, 200} // 8bit, for low/middle/high region
#define AE_WDR_HIST_SHADOWS_TARGET                  {  4,  4,  4}   // 8bit, for low/middle/high region
#define AE_WDR_HIST_HIGHLIGHT_PERCENT_RANGE         {  3,  3,  3}   // scale by 100, means 10% for low/middle/high region
#define AE_WDR_HIST_SHADOWS_PERCENT_RANGE           { 10, 10, 10}   // scale by 100, means 10% for low/middle/high region
