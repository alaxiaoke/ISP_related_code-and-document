...
unsigned int allib_ae_set_debug_log_flag(enum LogLevel_em ae_debug_log_flag, BOOL file_tag)
{
    ...
    //    //errRet = _GXR_AE_INDIVDE_BUGLEVEL;
    //    return errRet;
    //}
...
void allib_ae_getlib_version(struct alaelib_version *ae_libversion)
{
    ...
    LOG_INFO("AE ver: %ld_V%.2f", AE_LIB_MAJOR_VER, AE_LIB_MINOR_VER);
    LOG_DEBUG("AE ver: %ld_V%.2f", AE_LIB_MAJOR_VER, AE_LIB_MINOR_VER);
}
...
unsigned char allib_ae_loadfunc(struct alaeruntimeobj *aec_run_obj, UINT32 identityid)
{
    ...
    LOG_DEBUG("camera ID: %d", identityid);
    return result;
}
...
unsigned int alAE_set_param(struct ae_set_param_t *param, struct ae_output_data_t *ae_output, void *ae_runtime_dat)
{
    ...
    switch(param->ae_set_param_type)
    {
        ...
        case AE_SET_PARAM_iAE_TUNING_PARAM:
            ...
            //for (int index = 0; index < MAX_IAE_PARA_SWITCH_CASE; index++)
            //{
            //    ae_obj->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_dark_high = param->set_param.iAE_param.wdr_hist_shadows_target[index];
            //    ae_obj->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_dark_low = param->set_param.iAE_param.wdr_hist_shadows_target[index];
            //    ae_obj->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_sat_high = param->set_param.iAE_param.wdr_hist_highlight_target[index];
            //    ae_obj->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_sat_low = param->set_param.iAE_param.wdr_hist_highlight_target[index];
            //    ae_obj->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_dark_range_end[0] = param->set_param.iAE_param.wdr_hist_shadows_percent_range[index];
            //    ae_obj->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_dark_range_end[1] = param->set_param.iAE_param.wdr_hist_shadows_percent_range[index];
            //    ae_obj->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_dark_range_end[2] = param->set_param.iAE_param.wdr_hist_shadows_percent_range[index];
            //    ae_obj->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_dark_range_start[0] = 0;
            //    ae_obj->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_dark_range_start[1] = 0;
            //    ae_obj->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_dark_range_start[2] = 0;
            //    ae_obj->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_sat_pushdown_range_end[0] = param->set_param.iAE_param.wdr_hist_highlight_percent_range[index];
            //    ae_obj->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_sat_pushdown_range_end[1] = param->set_param.iAE_param.wdr_hist_highlight_percent_range[index];
            //    ae_obj->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_sat_pushdown_range_end[2] = param->set_param.iAE_param.wdr_hist_highlight_percent_range[index];
            //    ae_obj->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_sat_pushdown_range_start[0] = 0;
            //    ae_obj->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_sat_pushdown_range_start[1] = 0;
            //    ae_obj->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_sat_pushdown_range_start[2] = 0;
            //    ae_obj->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_sat_pushup_range_end[0] = param->set_param.iAE_param.wdr_hist_highlight_percent_range[index];
            //    ae_obj->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_sat_pushup_range_end[1] = param->set_param.iAE_param.wdr_hist_highlight_percent_range[index];
            //    ae_obj->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_sat_pushup_range_end[2] = param->set_param.iAE_param.wdr_hist_highlight_percent_range[index];
            //    ae_obj->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_sat_pushup_range_start[0] = 0;
            //    ae_obj->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_sat_pushup_range_start[1] = 0;
            //    ae_obj->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_sat_pushup_range_start[2] = 0;
            //    ae_obj->ae_tuning_para.iAE_para.iAE_tuning_para[index].max_adjust_ratio = 100;
            //    ae_obj->ae_tuning_para.iAE_para.iAE_tuning_para[index].min_adjust_ratio = 100;
            //    ae_obj->ae_tuning_para.iAE_para.iAE_tuning_para[index].max_midtones_gain = param->set_param.iAE_param.wdr_max_midtones_gain[index];
            //    ae_obj->ae_tuning_para.iAE_para.iAE_tuning_para[index].max_shadows_gain = param->set_param.iAE_param.wdr_max_shadows_gain[index];
            //}
        ...
        case AE_SET_PARAM_SENSOR_HW_EXPO_UPDATE:
            ...
            ae_obj->ae_runtime_data.minExpBV = alAELib_CalculateBv_midtones_comp(ae_obj->curHWSetting.FN_x1000, ae_obj->ae_shadow_set_param.para.preview_sensor_info.exposuretime_per_exp_line_ns / 1000, ae_obj->ae_current_set_param.para.preview_sensor_info.min_gain, ae_obj->ae_initial_param.midtones_gain);
            break;
        ...
        case AE_SET_PARAM_TARGET_MODE:
            scene_mode = param->set_param.ae_target_mode;
            if (scene_mode >= AE_TARGET_MAX_MODE || scene_mode < 0)
            {
        ...
        case AE_SET_PARAM_EXPO_MODE:
            scene_mode = param->set_param.ae_expo_mode;
            if (scene_mode >= AE_EXPO_MAX_MODE || scene_mode < 0)
            {
...
unsigned int alAE_get_param(struct ae_get_param_t *param, void *ae_runtime_dat)
{
    ...
    switch(param->ae_get_param_type)
    {
        ...
        case AE_GET_MANUAL_EV_COMPENSATION:
            ...
            break;
        case AE_GET_INIT_PIPEDELAY:
            param->para.pipeDelay = ae_obj->ae_shadow_set_param.para.pipeDelay;
            break;
...
unsigned int alAE_process(void *hw3a_ae_stats_data, void *hw3a_yhis_stats_data, struct alhw3a_ae_proc_data_t ae_proc_data, void *ae_runtime_dat, struct ae_output_data_t *ae_output)
{
    ...
    else
    {
        ...
        else
        {
            ...
            LOG_DEBUG("effect midtones_gain is %d", midtones_gain);
    ...
    bool gainFlag = alAELib_Abs(ae_obj->ae_current_set_param.para.sof_notify_param.exp_adgain - ae_obj->ae_current_output_dat.udsensor_ad_gain) < 1 ? true : false;
    bool shutterFlag = alAELib_Abs(ae_obj->ae_current_set_param.para.sof_notify_param.exp_time - ae_obj->ae_current_output_dat.udexposure_time) < 10 ? true : false;
    if ((gainFlag == false) || (shutterFlag == false)) //converged or hdr done, output fresh off
    {
    ...
    LOG_DEBUG("[OUT]iso/ad_gain/expoTime: %d/%d/%d, AE ver: %ld_V%.2f", output->iso, output->udsensor_ad_gain, output->udexposure_time, AE_LIB_MAJOR_VER, AE_LIB_MINOR_VER);
    LOG_DEBUG("[OUT]midtones_gain/shadows_gain: %d/%d", output->midtones_gain, output->shadows_gain);
    LOG_DEBUG("[OUT]bg_bv/bv/lux/ymean_8bit: %d/%d/%d/%d\n", output->bg_bvresult, output->bvresult, output->lux_result, output->ymean100_8bit);

    LOG_INFO("lib_runtime_st.uwCountingIdx: %d\n", ae_obj->lib_runtime_st.uwCountingIdx);
...
UINT32 alAE_estimation(void *ae_runtime_dat)
{
    ...
    else if (ae_obj->lib_runtime_st.ucIsConverged == 1 && alAELib_Abs(udAE_Targetmean - ae_mean_8bit) > 400)
    {
        ...
        //reset wdr param
        //ae_obj->ae_runtime_data.uwiAE_shortTargetMean = 0;
        //ae_obj->ae_runtime_data.uwmidtones_gain = 100;
    }
...
UINT32 gazeAE(void* ae_runtime_dat)
{
    ...
    for (int i = 0; i < roi_num; i++)
    {
        ...
        gaze_ae_runtime_dat.ae_tuning_para.ucWeightTable_user_weight = 100.0 / win2_weight[i] * 3.3;
...
UINT32 alAELib_GetExposureParameter(ae_corelib_obj_t *ptAEBuffer, al_ae_exp_param_t *ae_output, INT16 wBv1000)
{
    ...
    else
    {
        ...
        case AE_EXPO_NORMAL:
            matchExpoTable(ptAEBuffer, ae_output, wBv1000);
        ...
        case AE_EXPO_USERDEF:
            matchExpoTableNotATF(ptAEBuffer, ae_output, wBv1000);
            udISOSpeed = ae_output->udISO;
            udExpTime = ae_output->udexposure_time;
            break;
...
string UnicodeToAnsi_strCore(const wchar_t* szStr)
{
...
string GetCurrMoudleCore()
{
    HMODULE hModule = NULL;
    TCHAR dllDir[4096] = { 0 };
    GetModuleHandleEx(GET_MODULE_HANDLE_EX_FLAG_FROM_ADDRESS, (LPCWSTR)&GetCurrMoudleCore, &hModule);
    if (NULL != hModule)
    {
        GetModuleFileName(hModule, (LPWSTR)dllDir, 4096);
    }
    string dllAddr;
    dllAddr = UnicodeToAnsi_strCore(dllDir);
...
UINT32 LoadDefaultAESetting(void *ae_obj)
{
    ...
    //defalut tuningbin
    string dllAddr = GetCurrMoudleCore();
    string txtAddr;
    ...
    {
        LOG_ERROR("loaddefault 打开AEParam.bin失败！ %s\n", txtAddr.c_str());
    }
    localBuf->ae_shadow_set_param.para.ae_metering_mode = (ae_metering_mode_type_t)paramSim.paramSingleInt[ae_metering_mode][1];
    localBuf->ae_shadow_set_param.para.converge_speedlv = (ae_converge_level_type_t)paramSim.paramSingleInt[converge_speedlv][1];
    localBuf->ae_shadow_set_param.para.manual_isolevel = (ae_iso_mode_t)paramSim.paramSingleInt[manual_isolevel][1];
    localBuf->ae_shadow_set_param.para.manual_exptime = paramSim.paramSingleInt[manual_exptime][1];
    localBuf->ae_shadow_set_param.para.manual_adgain = paramSim.paramSingleInt[manual_adgain][1];
    localBuf->ae_shadow_set_param.para.manual_ae_target = paramSim.paramSingleInt[manual_ae_target][1];
    localBuf->ae_tuning_para.iAE_para.ucIsEnableiAE = paramSim.wdrEnable;
    localBuf->ae_shadow_set_param.para.ae_target_mode = (ae_target_mode_type_t)paramSim.paramSingleInt[ae_target_mode][1];
    localBuf->ae_shadow_set_param.para.ae_expo_mode = (ae_expo_mode_type_t)paramSim.paramSingleInt[ae_expo_mode][1];
    localBuf->ae_tuning_para.ucAntiFlickerMode = (ae_antiflicker_mode_t)paramSim.paramSingleInt[ucAntiFlickerMode][1];
    for (index = 0; index < MAX_IAE_PARA_SWITCH_CASE; index++)
    {
        localBuf->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_dark_high = paramSim.paramIAEHist[0][index];
        localBuf->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_dark_low = paramSim.paramIAEHist[1][index];
        localBuf->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_sat_high = paramSim.paramIAEHist[2][index];
        localBuf->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_sat_low = paramSim.paramIAEHist[3][index];
        localBuf->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_dark_range_end[0] = paramSim.paramIAEHist[4][index];
        localBuf->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_dark_range_end[1] = paramSim.paramIAEHist[5][index];
        localBuf->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_dark_range_end[2] = paramSim.paramIAEHist[6][index];
        localBuf->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_dark_range_start[0] = paramSim.paramIAEHist[7][index];
        localBuf->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_dark_range_start[1] = paramSim.paramIAEHist[8][index];
        localBuf->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_dark_range_start[2] = paramSim.paramIAEHist[9][index];
        localBuf->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_sat_pushdown_range_end[0] = paramSim.paramIAEHist[10][index];
        localBuf->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_sat_pushdown_range_end[1] = paramSim.paramIAEHist[11][index];
        localBuf->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_sat_pushdown_range_end[2] = paramSim.paramIAEHist[12][index];
        localBuf->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_sat_pushdown_range_start[0] = paramSim.paramIAEHist[13][index];
        localBuf->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_sat_pushdown_range_start[1] = paramSim.paramIAEHist[14][index];
        localBuf->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_sat_pushdown_range_start[2] = paramSim.paramIAEHist[15][index];
        localBuf->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_sat_pushup_range_end[0] = paramSim.paramIAEHist[16][index];
        localBuf->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_sat_pushup_range_end[1] = paramSim.paramIAEHist[17][index];
        localBuf->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_sat_pushup_range_end[2] = paramSim.paramIAEHist[18][index];
        localBuf->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_sat_pushup_range_start[0] = paramSim.paramIAEHist[19][index];
        localBuf->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_sat_pushup_range_start[1] = paramSim.paramIAEHist[20][index];
        localBuf->ae_tuning_para.iAE_para.iAE_tuning_para[index].hist_sat_pushup_range_start[2] = paramSim.paramIAEHist[21][index];
        localBuf->ae_tuning_para.iAE_para.iAE_tuning_para[index].max_adjust_ratio = paramSim.paramIAEHist[22][index];
        localBuf->ae_tuning_para.iAE_para.iAE_tuning_para[index].min_adjust_ratio = paramSim.paramIAEHist[23][index];
        localBuf->ae_tuning_para.iAE_para.iAE_tuning_para[index].max_midtones_gain = paramSim.paramIAEHist[24][index];
        localBuf->ae_tuning_para.iAE_para.iAE_tuning_para[index].max_shadows_gain = paramSim.paramIAEHist[25][index];
        localBuf->ae_tuning_para.iAE_para.iAE_tuning_para[index].max_isp_midtones_gain = paramSim.paramIAEHist[26][index];
    }
    for (int i = 0; i < MAX_IAE_BVTH_COUNT; i++)
    {
        localBuf->ae_tuning_para.iAE_para.iaeluxIdxTh[i] = paramSim.paramIAEBVTh[i];
    }
    for (int i = 0; i < MAX_IAE_HISTRATIO_COUNT; i++)
    {
        localBuf->ae_tuning_para.iAE_para.iaeHistRatio[i] = paramSim.paramIAEHistRatio[i];
    }
    localBuf->ae_tuning_para.iAE_para.WDRMode = (WDRMode)paramSim.paramIAEHistRatio[6];
    localBuf->ae_tuning_para.iAE_para.wdrTargetGainInTh = paramSim.paramIAEHistRatio[7];
    localBuf->ae_tuning_para.iAE_para.wdrTargetGainOutTh = paramSim.paramIAEHistRatio[8];
    for (int i = 0; i < SCENECNT; i++)
    {
        localBuf->ae_shadow_set_param.para.ae_target_table[i].aeTargetEn = paramSim.targetTable[i].aeTargetEn;
        memcpy(localBuf->ae_shadow_set_param.para.ae_target_table[i].table, paramSim.targetTable[i].aetargetTable, sizeof(localBuf->ae_shadow_set_param.para.ae_target_table[i].table));
    }
    for (int i = 0; i < AETABLE_CNT; i++)
    {
        localBuf->ae_shadow_set_param.para.ae_expo_table[i].aeExpoEn = paramSim.expousureTable[i].aeExpoEn;
        memcpy(localBuf->ae_shadow_set_param.para.ae_expo_table[i].table, paramSim.expousureTable[i].aeExpoTable, sizeof(localBuf->ae_shadow_set_param.para.ae_expo_table[i].table));
    }
    ...
    localBuf->ae_tuning_para.ucWeightTable_user_weight = 1.3;
    ...
    localBuf->ae_shadow_set_param.para.ae_enable = paramSim.configInfo.aeEnable;
    localBuf->ae_shadow_set_param.para.pipeDelay = paramSim.configInfo.pipedelay;
    localBuf->ae_shadow_set_param.para.preview_sensor_info.f_number_x1000 = paramSim.configInfo.fNumberx1000;
    localBuf->ae_shadow_set_param.para.preview_sensor_info.max_fps = paramSim.configInfo.maxfps;
    localBuf->ae_shadow_set_param.para.preview_sensor_info.min_fps = paramSim.configInfo.minfps;
    localBuf->ae_shadow_set_param.para.preview_sensor_info.max_gain = paramSim.configInfo.maxGain;
    localBuf->ae_shadow_set_param.para.preview_sensor_info.min_gain = paramSim.configInfo.minGain;
    localBuf->ae_shadow_set_param.para.preview_sensor_info.max_line_cnt = paramSim.configInfo.maxLineCnt;
    localBuf->ae_shadow_set_param.para.preview_sensor_info.min_line_cnt = paramSim.configInfo.minLineCnt;
    
    localBuf->ae_shadow_set_param.para.preview_sensor_info.sw_max_exptime = paramSim.configInfo.swMaxExptime;   // unit: us
    localBuf->ae_shadow_set_param.para.preview_sensor_info.sw_min_exptime = paramSim.configInfo.swMinExptime;   // unit: us
    localBuf->ae_shadow_set_param.para.preview_sensor_info.exposuretime_per_exp_line_ns = paramSim.configInfo.exptimePerLineNs;        // unit: ns
    ...
    localBuf->ae_runtime_data.minExpBV = alAELib_CalculateBv_midtones_comp(localBuf->curHWSetting.FN_x1000, localBuf->ae_shadow_set_param.para.preview_sensor_info.exposuretime_per_exp_line_ns / 1000, localBuf->ae_shadow_set_param.para.preview_sensor_info.min_gain, localBuf->ae_initial_param.midtones_gain);
    return err;
}
...
INT32 alAELib_CalculateProgressiveAE(INT32 wNowBV1000, INT32 wTargetBV1000, UINT8 a_ucConverge_SPD, ae_corelib_obj_t *ptAEBuffer)
{
    ...
    INT32 xt = wTargetBV1000;
    INT32 bt = beta * (xt - wNowBV1000) + (1 - beta) * prebt;
    ...
    if ((wNowBV1000 <= xt && wBv >= xt) || (wNowBV1000 >= xt && wBv <= xt))
    {
        wBv = xt;
    }
