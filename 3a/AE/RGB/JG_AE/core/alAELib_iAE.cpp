...
void hist_mean_monitor(ae_core_iae_tuning_param_t *param, UINT32 *hist, UINT16 length, HIST_MEAN_RESULT *result, UINT8 color_idx)
{
    ...
    UINT32 pushup_s = (1000 * n_hist - n_hist * param->hist_sat_pushup_range_start[color_idx]) / 1000;
    UINT32 pushup_e = (1000 * n_hist - n_hist * param->hist_sat_pushup_range_end[color_idx]) / 1000;
    UINT32 pushdown_s = (1000 * n_hist - n_hist * param->hist_sat_pushdown_range_start[color_idx]) / 1000;
    UINT32 pushdown_e = (1000 * n_hist - n_hist * param->hist_sat_pushdown_range_end[color_idx]) / 1000;
    UINT32 dark_s = (n_hist * param->hist_dark_range_start[color_idx]) / 1000;
    UINT32 dark_e = (n_hist * param->hist_dark_range_end[color_idx]) / 1000;
