...
#pragma pack(push) /* push current alignment setting to stack */
#pragma pack(4)    /* new alignment setting */
struct ae_sensorExpoList {
    float frameID;
    float shutter;
    float sensorGain;
    float ispGain;
    float midtoneGain;
    float ispmidtoneGain;
};
#pragma pack(pop)  /* restore old alignment setting from stack */

#pragma pack(push) /* push current alignment setting to stack */
#pragma pack(4)    /* new alignment setting */
struct ae_getAWBaInfo {
    uint16 rGain;
    uint16 gGain;
    uint16 bGain;
};
...
struct ae_set_param_content_t {
    ...
    UINT8                           pipeDelay;
    UINT32                          frameid;
    struct ae_sensorExpoList        expoSOFOut;
    struct ae_getAWBaInfo           awbInfo;
    struct multiCamStruct           multiCamSetParam;
    UINT8                           ucAntiFlickerMode;
};
#pragma pack(pop)  /* restore old alignment setting from stack */
...
enum ae_set_param_type_t {
    ...
    AE_SET_PARAM_INITEXPOLIST,
    AE_SET_PARAM_FRAMEID,
    AE_SET_PARAM_EXPOSOFOUT,
    AE_SET_PARAM_AWBGAIN,

    /*multiCamera Param*/
    AE_SET_PARAM_MULTICAM_PARAM,
    AE_SET_PARAM_MAX
};
...
enum ae_get_param_type_t {
    ...
    AE_GET_CUREXPOLIST,
    AE_GET_CUREXPOLISTFRONT,
    AE_GET_MAXSENSORGAIN,
    AE_GET_PARAM_MAX
};
...
struct ae_get_param_t {
    ...
    enum ae_antiflicker_mode_t      afd_flicker_mode;           /*!< anti-flicker mode from AFD output results or UI setting */
    struct ae_exif_info_t       exif_info;                  /*!<*/
    ...
    struct ae_sensorExpoList        expoSOF;
