...
#define _AL_WRP_AE_EMPTY_ISPDATA                    (_AL_AELIB_WRP_AE + 0x0B)
#define _AL_WRP_AE_EMPTY_ATFDATA                    (_AL_AELIB_WRP_AE + 0x0C)
#define _AL_WRP_AE_EMPTY_AWBDATA                    (_AL_AELIB_WRP_AE + 0x0D)
#define _AL_WRP_AE_EMPTY_EXPOSOFLIST                (_AL_AELIB_WRP_AE + 0x0E)
...
#define _AL_AELIB_INVALID_HANDLE                    (_AL_AELIB_LIBPROCESS + 0x03)
#define _AL_AELIB_INVALID_INPUTDATA                 (_AL_AELIB_LIBPROCESS + 0x04)
...
#define _AL_AELIB_INVALID_PIPEDELAY                 (_AL_AELIB_SETPARAM + 0x0B)
#define _AL_AELIB_INVALID_METERINGMODE              (_AL_AELIB_SETPARAM + 0x0C)
#define _AL_AELIB_INVALID_TARGET_MODE               (_AL_AELIB_SETPARAM + 0x0D)
#define _AL_AELIB_INVALID_EXPO_MODE                 (_AL_AELIB_SETPARAM + 0x0E)
#define _AL_AELIB_INVALID_IAE_PARA                  (_AL_AELIB_SETPARAM + 0x0F)
#define _AL_AELIB_INVALID_TABLE_PARA                (_AL_AELIB_SETPARAM + 0x10)
#define _AL_AELIB_INVALID_DEBUGLEVEL                (_AL_AELIB_SETPARAM + 0x11)
