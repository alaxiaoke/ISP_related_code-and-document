...
*                             Semiconductor                            *
*                                                                           *
*                   (C) COPYRIGHT 2023  SEMICONDUCTOR                  *
*                            ALL RIGHTS RESERVED                            *
*                                                                           *
...
typedef unsigned int (*allib_awb_process_func)(void *hw3a_stats_data, void *awb_dat, struct allib_awb_output_data *awb_output, void *debugbuf);
