...
typedef UINT32(*allib_afd_push_stats_func)(void *g_channel_rows_avg_data, void* g_channel_rows_group, void *afd_dat);
...
/* debug set*/
//unsigned int allib_atf_set_debug_log_flag(enum LogLevel_em ae_debug_log_flag, BOOL file_tag);
unsigned int allib_atf_set_debug_log_flag(int ae_debug_log_flag, BOOL file_tag, BOOL teminal_tag);
