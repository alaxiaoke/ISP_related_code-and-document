...
GXR_RAW2BGR_ExternC int gxr_raw2bgr_initialize(gxr_raw2bgr* mr);

GXR_RAW2BGR_ExternC void gxr_raw2bgr_release(gxr_raw2bgr* mr);

GXR_RAW2BGR_ExternC void gxr_raw2bgr_run_all(gxr_raw2bgr* mr); // 一张图用一个实例来调，如果要不同线程调，返回了再调

GXR_RAW2BGR_ExternC GXR_RAW2BGR_VERSION gxr_raw2bgr_version();