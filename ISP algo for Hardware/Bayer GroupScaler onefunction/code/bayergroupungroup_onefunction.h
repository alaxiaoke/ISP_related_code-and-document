#pragma once
#ifndef _BAYER_GROUPUNGROUP_ONEFUNCTION_H_
#define _BAYER_GROUPUNGROUP_ONEFUNCTION_H_
...
private:
	...
	int32_t CalTrans(int32_t group_flag, int32_t j, int32_t ws, int32_t bayerscalerw);

	int32_t GetCoorPhaseOne(int32_t* wt, int32_t* wto, int32_t* wst, int32_t widthg, int32_t widthin, int32_t bayerscalerw,
							int32_t wo1padlen,int32_t lutwlogstep,int32_t lutwlenleft,int32_t lutwlenall,int32_t* lutw);

	int32_t GetCoorPhaseUngroupOne(int32_t* wt,int32_t* wto,int32_t* wst,int32_t widthg,int32_t bayerscalerw,int32_t lutwlenall,
								int32_t lutwlenleft,int32_t ho1padlen,int32_t lutwlogstep,int32_t* lutw);

	int32_t GetLinebuffOne(uint16_t* Src);
	int32_t GetLinebuffUngroupOne(uint16_t* Src);

	int32_t CalWeightLineIdxOne(int32_t rown, int32_t maxcoor);
	int32_t VerProcOneLineOne(uint16_t* Dst);
	int32_t VerProcOne(uint16_t* Dst_Data, uint16_t* Src_Data);
	int32_t HorProcOne(uint16_t* Dst_Data, uint16_t* Src_Data);
	int32_t HorProcOneLineOne(uint16_t* Dst, uint16_t* Src);
...
public:
	...
	int32_t GroupUngroup(uint16_t* Dst_Data, uint16_t* Src_Data, int mode);
};
