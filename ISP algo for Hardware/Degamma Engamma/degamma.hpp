...
#ifndef degamma_min
#define degamma_min(a,b) (((a) < (b)) ? (a) : (b))
#endif

#ifndef degamma_max
#define degamma_max(a,b) (((a) > (b)) ? (a) : (b))
#endif

#ifndef clip
#define clip(x,a,b) (degamma_min(degamma_max(x,a),b))
#endif
...
typedef struct
{
	...
	int32_t RegLut[64];// u12
	int32_t RegLutFinal;// u13

	int32_t RegBoundary[5];// u8
